...
class ImageDialog extends React.Component {
  ...
  getResult() {
    const {
      tab, imageFile, imageUrl, imageError,
    } = this.state;
    if (tab === 0) {
      return imageFile;
    }
    ...
    return (
      <Dialog fullWidth
          ...
          {this.state.tab === 0 && (
            <div>
              {this.state.imageFile ? (
                <img src={this.state.imageFile.preview}
                     style={{
                       width: '100%',
                       maxHeight: '1000px',
                       objectFit: 'cover',
                ...
                <Dropzone onDrop={this.loadImageFile}
                          multiple={false}
                          style={{
                            width: '100%',
                            height: '200px',
        ...
        <DialogActions>
          ...
          <Button onClick={() => this.props.onClose(this.getResult())}
                  color="primary">
            추가
          </Button>
        </DialogActions>
